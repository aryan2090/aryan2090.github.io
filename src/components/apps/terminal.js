...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["books", "projects", "personal-documents", "skills", "languages", "PES", "interests"],
            PES: ["Sem-4"],
            ...
            skills: ["ML", "React.js", "jQuery"],
            projects: ["aryan2090-personal-portfolio", "Expense-Tracker", "Forkify"],
